...
- **Integridad de dependencias (SRI)**: D3plus v4, Leaflet y three.js se cargan por CDN con `integrity` y `crossorigin`. Si el archivo servido cambia un byte, el navegador lo rechaza; el motor de gráficos cae entonces a su renderizador SVG propio.
