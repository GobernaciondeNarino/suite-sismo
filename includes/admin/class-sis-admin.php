	...
	public function pantalla_elementos() {
		...
		<details class="sis-ayuda">
			...
			<div class="sis-ayuda__cuerpo">
				...
				<p><strong><?php esc_html_e( 'El globo:', 'sismos-narino' ); ?></strong> <?php esc_html_e( 'abre mostrando el planeta entero con la sismicidad de los últimos 30 días, hoy incluido. Los botones «Zona sísmica» y «Nariño» pasan al ámbito publicado en el shortcode. Para que abra ya en uno de esos dos, use vista="sismos" o vista="narino".', 'sismos-narino' ); ?></p>
